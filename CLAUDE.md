...
it rather than plateauing against it. Three docs, two code comments and the
...
right all along and is the wording to copy. `RAG_EF_SEARCH` survives as a bootstrap
