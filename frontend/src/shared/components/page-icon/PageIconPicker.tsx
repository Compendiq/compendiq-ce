...
import { Search, Smile, Shapes, ImagePlus, Trash2 } from 'lucide-react';
            ...
            <div>
              ...
              >
                {icons.map((item) => {
                  ...
                  const selected = icon?.kind === 'lucide' && icon.value === item.value;
                  return (
                    <button
                      key={item.value}
                      type="button"
                      ...
                      onClick={() => onSelect({ kind: 'lucide', value: item.value })}
                    >
