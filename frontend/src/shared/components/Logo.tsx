 ...
 * - The two magnifier strokes → hard-coded Steel #86aec8. This is the brand
 ...
 * #e8ecf5 / #6ea8ff) → Graphite/teal → the current Graphite/Steel values. The mark is the most
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#e7e9eb"
      />
      <path d="M618.125,618.125l165.375,165.375" fill="none" stroke="#86aec8" strokeWidth="67.5" />
      <text
        x="1064.82"
        y="692.255"
        fill="currentColor"
      ...
      <g>
        ...
        <path d="M3723.288,649.755l101.86,101.86" fill="none" stroke="#86aec8" strokeWidth="40.28" strokeLinejoin="bevel" />
      </g>
    </svg>
  );
}
