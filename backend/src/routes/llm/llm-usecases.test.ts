...
describe.skipIf(!dbAvailable)('GET /api/admin/llm-usecases', () => {
  it('returns all 9 rows with resolved blocks (#1417 adds inline completion, #1615 image analysis)', async () => {
    ...
    // image_embedding and #1615's image_analysis follow the same rule.
    for (const u of ['rerank', 'image_embedding', 'inline_completion', 'image_analysis']) {
