...
- Bei paläomagnetischen Messungen dieser Basalte entdeckte man, dass die wiederholte Umpolung des Erdmagnetfelds im Laufe der Erdgeschichte ein spiegelsymmetrisches „Streifenmuster“ auf beiden Seiten des Mittelatlantischen Rückens erzeugt hatte.
...
→ *Hauptartikel: Mittelozeanischer Rücken*
...
Während die Realität der Kontinentaldrift unter Geowissenschaftlern kaum noch bezweifelt wird, sind die antreibenden Kräfte im Erdinnern noch aktueller Diskussionsgegenstand (siehe hierzu auch Mantelkonvektion). Zu den wichtigsten Theorien zählen die geodynamische Erklärung über Konvektionsströmungen (einschließlich Mantelplumes) und die auf der Schwerkraft basierenden Theorie der aktiven Lithosphärenplatten. Neben den beiden hier angeführten Theorien gehen einige Studien auch von der Erdrotation als weitere Antriebskomponenten aus. Diese Theorien galten lange Zeit als gegensätzlich, inzwischen werden sie jedoch eher als einander ergänzend angesehen, wobei der Theorie der aktiven Lithosphärenplatten der größte Einfluss als Antriebskraft zugeordnet wird.
...
Ob eine Art Plattentektonik auf anders aufgebauten Himmelskörpern stattfindet, ist nicht bekannt, aber vorstellbar. Als Kandidaten für konvektionsgetriebene weiträumige horizontale Krustenverschiebungen können die Monde Europa und Enceladus gelten. Den knapp erdmondgroßen Europa umhüllt ein Eispanzer von etwa 100 km Dicke über einem felsigen Mondkörper. Der Eispanzer könnte in den tieferen Bereichen teilweise oder vollständig aufgeschmolzen sein, so dass er möglicherweise wie Packeis auf einem Ozean schwimmt. Seit 2014 wurden immer mehr Hinweise, welche für auftretende Subduktion sprechen, entdeckt. Der nur etwa 500 km kleine Enceladus wird wahrscheinlich durch Gezeitenkräfte aufgeheizt. Flüssiges Wasser oder durch hohen Druck duktiles Eis könnte bei beiden Himmelskörpern an tiefreichenden Störungen aufsteigen und das spröde Eis der Kruste zur Seite drücken, was wiederum folgen ließe, dass andernorts Kruste verschluckt werden müsste. Die Oberfläche dieser Monde ist jedenfalls geologisch aktiv oder zumindest aktiv gewesen und zeigt Anzeichen dafür, dass dort eine Krustenerneuerung stattfand. Der Vulkanismus auf Io dagegen scheint derartig stark zu sein, dass stabile Krustenbereiche in der Art der Platten erst gar nicht entstanden sind.
