...
> Owner: Payments team · On-call: #payments-oncall · PagerDuty: payments-primary

This runbook describes how the Payments team deploys **payments-api** to production. It
...
3. Announce the deploy in #payments-oncall with the release tag.
4. Verify the staging soak has run for at least thirty minutes.

## Deploying

1. Tag the release: `git tag -a payments-api-vX.Y.Z -m "release"` and push the tag.
...
- Post the release notes in #payments-oncall.
...
Stop the promotion. Page the on-call engineer via PagerDuty: payments-primary. The detailed
...
- Quarterly: review this runbook with the Payments team and update the rota.
