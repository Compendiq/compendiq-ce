...
|------|-----------|---------------|
| `core/` | npm packages, `@compendiq/contracts` | Any domain |
...
| **Shared library reuse** | Any | If another project wants `@compendiq/core` or `@compendiq/llm`, extract to packages |
...
```
packages/
├── contracts/             # @compendiq/contracts (+ service interfaces)
├── core/                  # @compendiq/core
├── confluence/            # @compendiq/confluence
├── llm/                   # @compendiq/llm
├── knowledge/             # @compendiq/knowledge
├── foundation/            # @compendiq/foundation
└── server/                # @compendiq/server (composition root)
```
