...
| `routes/llm/llm-image-analysis.ts` (the image-analysis status and the three operator actions) or `features/settings/panels/ImageAnalysisProgressCard.tsx` | `03-backend-domains.md`, `04-frontend-structure.md`, `docs/runbooks/image-index.md` §5b |
