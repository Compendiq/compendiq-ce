...
flowchart LR
    subgraph routes["routes/ (HTTP entry points)"]
        ...
        rK["knowledge<br/>pages CRUD, relocate, versions, tags,<br/>embeddings, duplicates, pinned,<br/>templates, comments, search,<br/>analytics, export/import,<br/>notion connection"]
    end
    ...
    subgraph domains["domains/"]
        ...
        dK["<b>knowledge</b><br/>auto-tagger<br/>quality-worker<br/>summary-worker<br/>version-tracker<br/>duplicate-detector<br/>page-relocate-service<br/>notion-client<br/>notion-token-service<br/>notion-block-converter (#1459)"]
    end
